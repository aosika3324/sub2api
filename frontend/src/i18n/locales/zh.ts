export default {
  ...
  billingRates: {
    title: '费率说明',
    description: '查看你可用分组的生效倍率、模型基础单价与倍率后单价',
    refresh: '刷新',
    searchPlaceholder: '搜索渠道、模型或分组...',
    ...
    modelsTitle: '模型费率',
    modelsDescription: '同一个模型在不同渠道或分组下可能有不同的倍率后单价。',
    emptyGroups: '暂无可用分组',
    emptyModels: '暂无可见模型价格',
    emptyModelsHint: '模型价格目录沿用“可用渠道”的公开开关；若管理员未启用，可在使用记录中查看历史请求的实际扣费。',
    noMatches: '没有匹配的模型费率',
    noPricing: '未配置定价',
    noCustomRate: '无',
    exclusive: '专属',
    ...
    multiplierStandard: '标准倍率',
    multiplierImage: '图片倍率',
    columns: {
      channel: '渠道',
      platform: '平台',
      group: '分组',
