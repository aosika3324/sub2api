export default {
  ...
  billingRates: {
    ...
    refresh: '刷新',
    yourBestSaving: '你的会员价，最低已省 {percent}%',
    yourPriceLabel: '你的价格',
    standardPriceLabel: '标准价',
    savingBadge: '会员价 · 已省 {percent}%',
    standardBadge: '标准价',
    premiumBadge: '溢价 {percent}%',
    perMillion: '/ 百万 token',
    tokenAnalogy: '约 100 万 token ≈ 50 万汉字，相当于一部长篇小说',
    priceSummaryToken: '输入 {input} · 输出 {output} / 百万 token',
    priceSummaryImage: '每张图 {price}',
    priceSummaryPerRequest: '每次 {price}',
    moreVariants: '另有 {count} 个分组可选',
    bestValue: '最划算',
    sortLabel: '排序',
    sortCheapest: '最便宜优先',
    sortNameAsc: '名称 A-Z',
    ...
    billingDetails: '查看计费明细',
    whyThisPrice: '你的价格 = 标准价 × 你的折扣',
    pricingBasis: '定价依据',
    howPriceWorks: '价格是怎么算的？',
    howPriceWorksText: '每个模型有一个标准价，系统会按你的会员/分组折扣自动打折后展示。你看到的就是实际扣费单价；每次请求的最终费用按当时用量记录在使用记录里。',
    estimator: {
      title: '估算一下我要花多少',
      hint: '选一个常见用量，立刻看到预计每月花费',
      light: '轻度（偶尔问几句）',
      medium: '中度（每天当助手用）',
      heavy: '重度（高频编程/写作）',
      requestsPerDay: '每天大约 {count} 次请求',
      resultPrefix: '预计每月约',
      resultSuffix: '',
      cheapestHint: '最省的是 {model}，约 {price}/月',
      disclaimer: '仅为粗略估算，实际以使用记录扣费为准',
      pickModel: '选择模型',
    },
    footerNote: '价格快照于登录时生成，实际计费以使用记录为准。',
    emptyModels: '你的账户暂无可用模型，请联系管理员开通',
    noMatches: '没有匹配“{q}”的模型，试试别的关键词',
    clearSearch: '清除搜索',
    viewUsage: '查看使用记录',
    noPricing: '未配置定价',
    input: '输入',
    ...
    pricingSourceLiteLLM: '默认定价',
    pricingSourceFallback: '兜底定价',
    pricingSourceDisplay: '展示定价',
    pricingSourceUnknown: '未知来源',
    advanced: {
      coefficient: '精确折扣系数',
      variantImage: '图像',
      variantStandard: '标准',
