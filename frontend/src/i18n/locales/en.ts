export default {
  ...
  billingRates: {
    ...
    refresh: 'Refresh',
    yourBestSaving: "Members' price — save up to {percent}%",
    yourPriceLabel: 'Your price',
    standardPriceLabel: 'Standard price',
    savingBadge: '{percent}% off',
    standardBadge: 'Standard price',
    premiumBadge: '{percent}% above standard',
    perMillion: '/ 1M tokens',
    tokenAnalogy: '≈ 1M tokens is about 750k English words, roughly 1,500 pages',
    priceSummaryToken: 'Input {input} · Output {output} per 1M tokens',
    priceSummaryImage: '{price} per image',
    priceSummaryPerRequest: '{price} per request',
    moreVariants: '{count} more groups available',
    ...
    whyThisPrice: 'Your price = standard price × your discount',
    pricingBasis: 'Pricing basis',
    howPriceWorks: 'How is my price calculated?',
    howPriceWorksText: "Each model has a standard price. We automatically apply your member/group discount and show the result. The price you see is what you pay; each request's final charge is recorded in Usage.",
    estimator: {
      title: 'Estimate my cost',
      hint: 'Pick a typical usage level to see your projected monthly spend',
      light: 'Light (a few questions now and then)',
      medium: 'Medium (daily assistant use)',
      heavy: 'Heavy (frequent coding / writing)',
      requestsPerDay: 'About {count} requests per day',
      resultPrefix: 'About',
      resultSuffix: ' / month',
      cheapestHint: 'Cheapest is {model}, about {price}/month',
      disclaimer: 'Rough estimate only — actual charges are recorded in Usage',
      pickModel: 'Pick a model',
    },
    footerNote: 'Prices are snapshotted at login; actual billing is recorded in Usage.',
    emptyModels: 'No models available on your account yet — contact your admin',
    noMatches: 'No models match "{q}" — try another keyword',
    ...
    pricingSourceLiteLLM: 'Default pricing',
    pricingSourceFallback: 'Fallback pricing',
    pricingSourceDisplay: 'Display pricing',
    pricingSourceUnknown: 'Unknown source',
    advanced: {
      coefficient: 'Exact discount factor',
      variantImage: 'Image',
      variantStandard: 'Standard',
    },
    columns: {
      group: 'Group',
      billedPrice: 'Your price',
