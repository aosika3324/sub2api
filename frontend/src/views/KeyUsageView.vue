...
const RING_GRADIENTS = [
  { from: '#d97757', to: '#f6c9ba' },
  { from: '#E8A33D', to: '#F6D08A' },
  { from: '#6E9B7E', to: '#A9C7B2' },
  { from: '#C15A36', to: '#E59477' },
]
...
.skeleton {
  background: linear-gradient(90deg, #e5ddcf 25%, #f2ede3 50%, #e5ddcf 75%);
  background-size: 200% 100%;
  animation: shimmer-kv 1.8s ease-in-out infinite;
  border-radius: 8px;
}
:global(.dark) .skeleton {
  background: linear-gradient(90deg, #403b35 25%, #2a2622 50%, #403b35 75%);
  background-size: 200% 100%;
}
