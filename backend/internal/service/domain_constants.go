...
const (
	...
	SettingKeyExternalRechargeEnabled     = "external_recharge_enabled"     // 是否启用"外部充值"入口(余额/充值按钮跳转外链)
	SettingKeyExternalRechargeURL         = "external_recharge_url"         // 外部充值地址(新标签打开;为空则回退内置 /purchase)
