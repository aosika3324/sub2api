...
func (s *adminServiceImpl) CreateGroup(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	// simulate_claude_max_enabled 仅支持 anthropic 分组：先做平台兼容性校验，再校验数值字段。
	if input.SimulateClaudeMaxEnabled != nil && platform != PlatformAnthropic && *input.SimulateClaudeMaxEnabled {
