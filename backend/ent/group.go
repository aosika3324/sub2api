...
type Group struct {
	...
	// VeoVideoPricePerSecond holds the value of the "veo_video_price_per_second" field.
	VeoVideoPricePerSecond *float64 `json:"veo_video_price_per_second,omitempty"`
	...
	// whether /v1/messages dispatch is allowed for this OpenAI group
	AllowMessagesDispatch bool `json:"allow_messages_dispatch,omitempty"`
	// only non-apikey accounts can be associated with this group
	RequireOauthOnly bool `json:"require_oauth_only,omitempty"`
	// only accounts with privacy successfully configured can be used for dispatch
	RequirePrivacySet bool `json:"require_privacy_set,omitempty"`
	// default mapped model id when no account-level mapping exists
	DefaultMappedModel string `json:"default_mapped_model,omitempty"`
	// OpenAI messages dispatch model mapping config
	MessagesDispatchModelConfig domain.OpenAIMessagesDispatchModelConfig `json:"messages_dispatch_model_config,omitempty"`
	// custom /v1/models list response config
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig:
			values[i] = new([]byte)
		case group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldSimulateClaudeMaxEnabled:
			values[i] = new(sql.NullBool)
		case group.FieldRateMultiplier, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldSoraImagePrice360, group.FieldSoraImagePrice540, group.FieldSoraVideoPricePerRequest, group.FieldSoraVideoPricePerRequestHd, group.FieldVeoVideoPricePerSecond, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldVeoVideoPricePerSecond:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field veo_video_price_per_second", values[i])
			} else if value.Valid {
				_m.VeoVideoPricePerSecond = new(float64)
				*_m.VeoVideoPricePerSecond = value.Float64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	if v := _m.VeoVideoPricePerSecond; v != nil {
		builder.WriteString("veo_video_price_per_second=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
