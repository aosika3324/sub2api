...
func (_u *APIKeyUpdate) SetInternal(v bool) *APIKeyUpdate {
	_u.mutation.SetInternal(v)
	return _u
}

// SetNillableInternal sets the "internal" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableInternal(v *bool) *APIKeyUpdate {
	if v != nil {
		_u.SetInternal(*v)
	}
	return _u
...
// SetInternal sets the "internal" field.
func (_u *APIKeyUpdateOne) SetInternal(v bool) *APIKeyUpdateOne {
	_u.mutation.SetInternal(v)
	return _u
}

// SetNillableInternal sets the "internal" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableInternal(v *bool) *APIKeyUpdateOne {
	if v != nil {
		_u.SetInternal(*v)
	}
	return _u
