...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, imageConcurrencyLimiter, opsService, grokQuotaService, configConfig, coordinator)
	...
	videoStudioRepository := repository.NewVideoStudioRepository(client)
	videoStudioService := service.ProvideVideoStudioService(userService, apiKeyService, billingCacheService, subscriptionService, geminiMessagesCompatService, gatewayService, videoStudioRepository)
	videoStudioHandler := handler.NewVideoStudioHandler(videoStudioService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, imageStudioHandler, videoStudioHandler, editableFileHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
